...
| userGcSPU | Data table | Table of growth curves and spatial unit combinations for each cohort | CBM_dataPrep |
| userGcMeta | Data table |  Species and growth curve IDs | [Google Drive](https://docs.google.com/spreadsheets/d/1LYnShgd0Q7idNNKX9hHYju4kMDwMSkW5/)   |
...
| gcMetaMeta     | Data table | Growth curve metadata |
